...
* [Обновление брони](#обновление-брони) (опционально)
...
то для отсутствующих ключей мы будем использовать предыдущее значение, т.е. ваши данные будут интерпретированы как:
...
Помимо указанных могут присутствовать ещё такие поля (при соответствующих настройках):

* payment_method - способ оплаты
* game_language - язык проведения игры
* game_mode - режим игры
* additional_services - дополнительные опции/услуги
* services_price - цена дополнительных опций/услуг
* services_commission - наша комиссия за доп. опции/услуги
* invoice_data - данные для отправки счёта-фактуры
...
На указанный вами URL будут приходить обновлённые данные брони (например, если поменялся статус оплаты, кол-во человек и т.п.).

Всегда будут присутствовать эти поля:
...
Следующие поля будут присутствовать только если их значения изменились:

* phone - телефон клиента
* comment - комментарий
* price - цена
* players_num - кол-во игроков
* is_paid - оплачен ли
